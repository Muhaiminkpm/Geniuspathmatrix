...
export default function AssessmentPage() {
  ...
  const handleSubmit = React.useCallback(async () => {
    ...
    // Call getCareerSuggestions directly (now using Groq API)
    console.log('[Assessment] Generating career suggestions with Groq AI...');
    ...
    if (result.success) {
      ...
      console.error('[Assessment] Failed to generate career suggestions:', result.error);
