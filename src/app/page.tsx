        ...
        <main className="flex-1 p-8 md:p-10 lg:p-12">
            <div className="mx-auto max-w-7xl space-y-12">
                <div className="space-y-4">
                    ...
                    <p className="text-xl font-medium text-primary">Your Blueprint for Career Excellence.</p>
                    <p className="text-lg text-muted-foreground max-w-3xl">
                        Path-GeniX™ is here to guide you through a structured, personalized, and metacognitive career discovery journey. Design Your Future, Today!
                    </p>
